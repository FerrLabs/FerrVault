...
- fix(operator): restart workloads with a patch instead of an update (#270)
...
- fix(controller): un 429 est un report, pas un echec de synchronisation (#249)

## [5.2.4] - 2026-08-28

### Bug Fixes

- fix(deps): update kubernetes monorepo to v0.37.0 (#238)

## [5.2.3] - 2026-08-26

### Bug Fixes

- fix(manager): read workloads uncached so declared rbac suffices (#240)

## [5.2.2] - 2026-08-10

### Bug Fixes

- fix(ci): accorde pull-requests write au job appelant les reusables (#222)
...
- fix(deps): update module github.com/prometheus/client_golang to v1.24.1 (#199)
...
- fix(deps): update module github.com/prometheus/client_golang to v1.24.0 (#191)
